...
public class GameOverScreen implements Screen {
    ...
    public void show() {
        ...
        this.camera.setToOrtho(false, game.grid.getGridWidth(), game.grid.getGridHeight());
        this.viewport = game.getViewport();
        this.viewport.setWorldSize(game.grid.getGridWidth(), game.grid.getGridHeight());
        stage.getViewport().setWorldSize(game.grid.getGridWidth(), game.grid.getGridHeight());
    }
